<nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm fixed-top navbar-main z-50">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex gap-2"><a href="login.php" class="button-sigin text-decoration-none">
                    <button class="btn btn-outline-success" type="button">
                        Sign In
                    </button></a>
                    <button class="btn btn-outline-danger" type="button" onclick="if(confirm('Yakin ingin logout?')) window.location.href='logout.php'">
