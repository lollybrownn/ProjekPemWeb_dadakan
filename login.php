...
<body>
    <div class="login-container">
        <div class="header">
            <div class="logo">
                <img src="nba-logo.png" alt="NBA Logo" style="height: 30px; margin-right: 5px;"> <span class="logo-id">ID</span>
            </div>
            <h1>SIGN IN OR CREATE YOUR NBA ID</h1>
        </div>
        
        <p class="description">
            Your NBA ID grants access to exclusive offers, personalized content, NBA events, and more - all just for being a fan.
        </p>
