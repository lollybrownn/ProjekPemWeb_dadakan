...
<body>
    ...
    <!-- Sub Navbar + Tanggal -->
    <nav class="navbar navbar-expand-lg bg-white border-bottom shadow-sm fixed-top" id="subNavbar"
                        ...
                        <div class="col-lg-5 bg-white p-4 d-flex align-items-center justify-content-center">
                            <div class="w-100 text-center">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <img src="https://cdn.nba.com/logos/nba/<?= teamCode($game['away_team']) ?>/primary/L/logo.svg"
                                            class="team-logo" alt="">
                                        <div class="mt-2 fw-bold fs-5"><?= shortName($game['away_team']) ?></div>
                                        <div class="score-big <?= $awayWin ? 'text-success' : '' ?>"><?= $game['away_score'] ?? '-' ?>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <h3 class="mb-0">VS</h3>
                                    ...
                                    <div class="col-5">
                                        <img src="https://cdn.nba.com/logos/nba/<?= teamCode($game['home_team']) ?>/primary/L/logo.svg"
                                            class="team-logo" alt="">
                                        <div class="mt-2 fw-bold fs-5"><?= shortName($game['home_team']) ?></div>
                                        <div class="score-big <?= $homeWin ? 'text-success' : '' ?>"><?= $game['home_score'] ?? '-' ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    <?php if ($game['box_score_file'] && file_exists($game['box_score_file'])): ?>
                                        <a href="<?= $game['box_score_file'] ?>" class="btn btn-outline-dark rounded-pill px-5">Box
                                            Score</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 bg-light p-4 d-flex align-items-center justify-content-center">
                            <div class="text-center w-100">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <img src="https://cdn.nba.com/headshots/nba/latest/260x190/1627742.png"
                                            class="leader-img" alt="">
                            ...
                            <?php if ($game['youtube_url']): ?>
                                <div class="w-100">
                                    ...
                                    <div class="ratio ratio-16x9 rounded-3 overflow-hidden shadow">
                                        <iframe src="<?= htmlspecialchars($game['youtube_url']) ?>" title="Highlights"
                                            frameborder="0"
